window.onload = function () {
  ...
  const dois = this.document.getElementById('dois').style.backgroundColor = `#${(Math.floor((Math.random() * (0, 16777215)) + 0)).toString(16)}`
  const tres = this.document.getElementById('tres').style.backgroundColor = `#${(Math.floor((Math.random() * (0, 16777215)) + 0)).toString(16)}`;
  const quatro = this.document.getElementById('quatro').style.backgroundColor = `#${(Math.floor((Math.random() * (0, 16777215)) + 0)).toString(16)}`;
